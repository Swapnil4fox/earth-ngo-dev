...
class Users extends MY_Controller {
	...
	public function index() {
		$data['info'] = $this->Common_model->getRecords('fx_users', array('is_delete' => 0));
	...
	public function trash() {
			...
			if (isset($_POST['checkbox_del'])) {
				if (count($_POST['checkbox_del']) != 0) {
					...
					for ($i = 0; $i < $cnt_checkbox_del; $i++) {
						...
						$where = ['id' => $_POST['checkbox_del'][$i]];
						$result = $this->Common_model->updateRecord('fx_users', $data, $where);
		...
		if (isset($_POST['multiple_delete_all'])) {
			if (isset($_POST['checkbox_del'])) {
				if (count($_POST['checkbox_del']) != 0) {
					...
					for ($i = 0; $i < $cnt_checkbox_del; $i++) {
						$where = ['id' => $_POST['checkbox_del'][$i]];
						$this->Common_model->delete('fx_users', $where);
					}
					$this->session->set_flashdata('success', 'User has been Deleted Successfully.');
					redirect(base_url('admin/users/trash'));
		...
		$data['info'] = $this->Common_model->getRecords('fx_users', array('is_delete' => 1));
