...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        <div class="col-md-8 col-lg-8">
            <h4 class="page-title"><?=trans('volunteer_list')?></h4>
            <div class="breadcrumb-list">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?=base_url();?>admin/dashboard"><?=trans('dashboard')?></a></li>
                    <li class="breadcrumb-item"><a href="javascript:void(0)"><?=trans('volunteer_list');?></a></li>
                </ol>
            </div>
        </div>
         <div class="col-md-4 col-lg-4">
            <div class="widgetbar">
                <a href="<?=base_url();?>admin/volunteer/add_edit" class="btn btn-primary-rgba"><i class="feather icon-plus mr-2"></i>Add volunteer</a>
            </div>
        </div>
    </div>
</div>
         ...
         <div class="col-lg-12">
            <div class="card m-b-30">
                <div class="card-header">
                    <h5 class="card-title mb-0"><?=trans('volunteer_list')?></h5>
                </div>
                <div class="card-body">
                    <?php $this->load->view('admin/includes/_messages.php')?>
                    <?php echo form_open(base_url('admin/volunteer/trash'), 'id="frmvalidate"'); ?>
                    ...
                    <a href="<?=base_url('admin/volunteer');?>">Volunteer List</a>
                    <?php } else {?>
                    ...
                    <a href="<?=base_url('admin/volunteer/trash');?>"><button class="btn btn-danger-rgba"> <i class="feather icon-trash-2"></i>Trash</button></a>
                    <?php }?>
                </div>
                    ...
                    <table id="example1" class="table table-bordered table-striped" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="width:18px"><input type="checkbox" class="checkbox_del" name="checkbox_del[]" id="checkbox_del[]" value="<?php echo $row['volunteerID']; ?>"/></td>
                                <td>
                                    <?=$row['volunteerID']?>
                                </td>
                                <td>
                                    <h4 class="m0 mb5"><img src="<?php echo base_url('uploads/volunteer/' . $row['volThumbImage']); ?>" width="100" height="100" class="img-responsive"/></h4>
                                </td>
                                <td>
                                    <?=$row['volunteerName']?>
                                </td>
                                <td>
                                    <?=$row['volunteerDesignation']?>
                                </td>
                                <td>
                                    <a href="<?=base_url("admin/volunteer/view/" . $row['volunteerID']);?>"><i class="feather icon-eye"></i></a>
                                    <a href="<?=base_url("admin/volunteer/add_edit/" . $row['volunteerID']);?>" class="btn btn-success-rgba" >
                                    <i class="feather icon-edit-2"></i>
                                    </a>
                                    <a href="<?=base_url("admin/volunteer/delete/" . $row['volunteerID']);?>" onclick="return confirm('are you sure to delete?')" class="btn btn-danger-rgba"><i class="feather icon-trash"></i></a>
                                </td>
                            </tr>
                            <?php endforeach;?>
                        </tbody>
